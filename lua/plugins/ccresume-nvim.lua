...
return {
  ...
  event = "VeryLazy",
  keys = {
    { "<leader>ch", function() require("ccresume").show_current_dir_conversations() end, desc = "現在ディレクトリのClaude Code履歴（直近）" },
    { "<leader>cH", function() require("ccresume").show_current_dir_conversations_all() end, desc = "現在ディレクトリのClaude Code履歴（全件）" },
    { "<leader>ca", function() require("ccresume").show_conversations() end, desc = "Claude Code履歴（直近）" },
    { "<leader>cA", function() require("ccresume").show_conversations_all() end, desc = "Claude Code履歴（全件）" },
  },
